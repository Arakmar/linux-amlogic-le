...
#define AMSTREAM_EXT_CURRENT_VIDEOFRAME_GET_GE2D_FORMAT _IOR((AMEXT_MAGIC), 0x03, u32)
#define AMSTREAM_EXT_CURRENT_VIDEOFRAME_GET_SIZE _IOR((AMEXT_MAGIC), 0x04, u64)
#define AMSTREAM_EXT_CURRENT_VIDEOFRAME_GET_CANVAS0ADDR _IOR((AMEXT_MAGIC), 0x05, u32)
